...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ln,depthTest:!1,depthWrite:!1})}function Zo(){return new Dn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Aa(),fragmentShader:`
		...
		`,blending:Ln,depthTest:!1,depthWrite:!1})}function Jo(){return new Dn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Aa(),fragmentShader:`
...
`].filter(tr).join(`
`)),a=ua(a),a=oc(a,t),a=cc(a,t),o=ua(o),o=oc(o,t),o=cc(o,t),a=lc(a),o=lc(o),t.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
`)+`
`+f);const S=E+m+a,T=E+f+o,N=sc(i,i.VERTEX_SHADER,S),w=sc(i,i.FRAGMENT_SHADER,T);i.attachShader(_,N),i.attachShader(_,w),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function b(L){if(r.debug.checkShaderErrors){const G=i.getProgramInfoLog(_).trim(),k=i.getShaderInfoLog(N).trim(),Y=i.getShaderInfoLog(w).trim();let q=!0,W=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(q=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,N,w);else{const j=ac(i,N,"vertex"),z=ac(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
