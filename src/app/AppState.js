...
export const AR_SESSION_STATES = {
  ...
  TRACKING_STARTING: 'trackingStarting',
...
export function createSessionPatch(nextStatus, patch = {}) {
  ...
  if (
    nextStatus === AR_SESSION_STATES.TRACKING_STARTING ||
    nextStatus === AR_SESSION_STATES.TRACKING_ERROR ||
    nextStatus === AR_SESSION_STATES.NO_FACE
  ) {
    return nextPatch;
  }
