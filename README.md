...
- `index.html`：包含繁體中文 title、description、robots、canonical、theme-color、mobile web app tags、Open Graph、Twitter Card 與 JSON-LD `@graph`；canonical、`og:url` 與 JSON-LD URL 由 build-time `VITE_SITE_URL` 注入。
